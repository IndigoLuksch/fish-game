...
io.on('connection', (socket) => {
    ...
    socket.on('createRoom', (playerName, callback) => {
        ...
        // The original code had an extra closing brace and semicolon here,
        // which has been removed to correctly add the player to the room.
        room.players.push(player);
        rooms.set(code, room);

        socket.join(code);
        socket.roomCode = code;
        socket.playerId = player.id; // Use persistent ID instead of socket.id
